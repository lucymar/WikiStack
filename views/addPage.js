...
module.exports = () =>
  layout(html `
    ...
    <div class="form-group">
    <label for="status" class="col-sm-2 control-label">Page Title</label>
    <div class="col-sm-10">
      <input type="radio" id="status" value="open"> Open </input>
      <input type="radio" id="status" value="closed"> Closed </input>
    </div>
    </div>
